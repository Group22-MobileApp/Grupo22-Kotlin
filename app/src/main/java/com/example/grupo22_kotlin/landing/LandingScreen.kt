package com.example.grupo22_kotlin.landing
...
import com.example.grupo22_kotlin.ui.theme.Montserrat
import com.example.grupo22_kotlin.ui.theme.Raleway
import com.example.grupo22_kotlin.ui.theme.darkBlue
...
fun MyLandingScreen() {
    Column(
        ...
        LandingFooter(modifier = Modifier.weight(1f))
    }
}
...
@Composable
fun LandingFooter(modifier: Modifier) {
    Column(
        modifier = modifier.fillMaxWidth(),
        verticalArrangement = Arrangement.Center,
        horizontalAlignment = Alignment.CenterHorizontally
